...
# 14. factorial
def factorial_(*args):
    return normalize(math.factorial(args[0]))

# 15. floor
def floor_(*args):
    return normalize(math.floor(args[0]))

# 16. square area
def square_area_(*args):
    return normalize(args[0] ** 2)

# 17. triangle area
def triangle_area_(*args):
    res = args[0]
    for arg in args[1:]:
        res *= arg
    return normalize(res/2)

# 18. rhombus area
def rhombus_area_(*args):
    res = args[0]
    for arg in args[1:]:
        res *= arg
    return normalize(res/2)
...
# 19. rectangle area
def rectangle_area_(*args):
    res = args[0] * args[1]
    return normalize(res)

# 20. surface cube
def surface_cube_(*args):
    res = 6 * args[0] ** 2
    return normalize(res)

# 21. surface rectangular prism (cuboid)
def surface_rectangular_prism_(*args):
    res = 2 * ((args[0] * args[1]) + (args[0] * args[2]) + (args[1] * args[2]))
    return normalize(res)
